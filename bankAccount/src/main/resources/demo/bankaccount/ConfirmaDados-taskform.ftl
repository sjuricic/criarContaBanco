<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("dadosOk_t");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid dadosOk_t");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: createBankAccount.ConfirmaDados
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">dadosOk_t</label>
                            		<div class="div_checkbox">
                              		<input name="dadosOk_t" type="checkbox" class="checkbox" id="dadosOk_t" value="${dadosOk_t}" />
                            		</div>
