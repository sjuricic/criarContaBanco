<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("cliente_out");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid cliente_out");
							myInputs[j].focus();
							return false;
						}
	...
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">cliente_in</label>
                            		<div class="div_checkbox">
                              		${cliente_in}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">cliente_out</label>
                            		<div class="div_texbox">
                              		<input name="cliente_out" type="text" class="textbox" id="cliente_out" value="${cliente_out}" />
                            		</div>
